  ...
  return (
    ...
    <section id="services" aria-labelledby="services-heading" className="py-16 sm:py-20 md:py-24 bg-[#f7f4f0]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-stone-700 text-base sm:text-lg leading-relaxed mb-8 sm:mb-12 max-w-2xl">
        ...
        <ul
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 mb-8 sm:mb-14 list-none p-0"
          aria-label="List of areas we help with"
        >
          {services.map(({ icon: Icon, label }) => (
            <li
              key={label}
              className="bg-white rounded-xl px-4 py-3 sm:py-4 flex items-center gap-3 border border-stone-200"
            >
              <Icon className="text-[#4a6e4c] shrink-0" size={18} aria-hidden="true" />
              <span className="text-stone-700 text-sm sm:text-base">{label}</span>
            </li>
          ))}
        </ul>
    ...
    <section aria-labelledby="crisis-heading" className="py-16 sm:py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <p className="text-stone-700 text-base sm:text-lg leading-relaxed mb-8 max-w-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <ul className="space-y-3 text-stone-700 text-sm sm:text-base">
            <li className="flex items-start gap-3">
              <span className="text-[#4a6e4c] font-bold shrink-0 mt-0.5">•</span>
          ...
          <blockquote className="bg-[#f7f4f0] rounded-2xl p-6 sm:p-8 mt-2 md:mt-0">
            <p className="font-serif text-base sm:text-lg text-stone-800 leading-relaxed italic">
              Please note: we are not able to diagnose or treat mental disorders and as such, are not able to provide any documentation to that effect.
            </p>
            <p className="font-serif text-base sm:text-lg text-stone-800 leading-relaxed italic mt-4">
              If you require a licensed mental health professional (ie: a psychiatrist or psychologist) please contact your GP to organise a referral.
        </p>
          </blockquote>
        </div>
      </div>
