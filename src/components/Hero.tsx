...
export default function Hero() {
  return (
    <section
      ...
      className="min-h-screen md:min-h-0 flex items-start bg-[#f7f4f0]"
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-8 pb-16 sm:pt-10 sm:pb-20 md:pt-12 md:pb-12 w-full">
