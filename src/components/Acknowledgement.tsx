export default function Acknowledgement() {
  return (
    <section aria-labelledby="acknowledgement-heading" className="py-16 sm:py-20 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <p className="text-[#4a6e4c] text-xs sm:text-sm font-semibold tracking-wider sm:tracking-widest uppercase mb-3 sm:mb-4" aria-hidden="true">
