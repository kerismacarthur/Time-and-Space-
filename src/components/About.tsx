      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-5 sm:gap-8">
          ...
          <article className="bg-[#f7f4f0] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8">
            ...
            <p className="text-stone-700 text-base leading-relaxed mb-3 sm:mb-4">
              With specialist experience in drug and alcohol counselling and a background in suicide prevention, Keris brings both depth and warmth to her work with individuals, couples and groups. In private practice, she brings an intersectional lens to complement her person-centred, process-oriented approach.
            </p>
            <p className="text-stone-700 text-base leading-relaxed">
